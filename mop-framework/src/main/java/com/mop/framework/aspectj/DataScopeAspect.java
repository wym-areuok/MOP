package com.mop.framework.aspectj;

import com.mop.common.annotation.DataScope;
...
import com.mop.framework.security.context.PermissionContextHolder;
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String userAlias, String deptAlias, String userField, String deptField, String permission) {
        ...
        for (SysRole role : user.getRoles()) {
            ...
            if (Constants.Dept.DATA_SCOPE_ALL.equals(dataScope)) {
                ...
                sqlString.append(StringUtils.format(" OR {}.{} IN ( SELECT dept_id FROM sys_dept WHERE dept_id = {} OR ',' + ancestors + ',' LIKE '%,' + CAST({} AS VARCHAR) + ',%' )", deptAlias, deptField, user.getDeptId(), user.getDeptId()));
