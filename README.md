...
| `server_a` | A服务器     | yml 配置 + 字典开关 |
| `server_b` | B服务器     | yml 配置 + 字典开关 |
| `server_c` | C服务器     | yml 配置 + 字典开关 |
| `server_d` | D服务器     | yml 配置 + 字典开关 |
| `server_e` | E服务器     | yml 配置 + 字典开关 |
