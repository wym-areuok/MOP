...
public class SysJob extends BaseEntity {
    ...
    @Schema(description = "计划策略（0=默认 1=立即触发执行 2=触发一次执行 3=不触发立即执行）",
            allowableValues = {"0", "1", "2", "3"}, example = "0")
     ...
     * 是否并发执行（0允许 1禁止）
     */
    @Schema(description = "是否并发执行（0=允许 1=禁止）", allowableValues = {"0", "1"}, example = "1")
     ...
     * 任务状态（0正常 1暂停）
     */
    @Schema(description = "任务状态（0=正常 1=暂停）", allowableValues = {"0", "1"}, example = "0")
